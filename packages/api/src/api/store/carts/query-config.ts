export const defaultGetCartFields = [
  'id',
  // 'currency_code',
  // 'email',
  // 'region_id',
  ...
  'credit_line_total',
  'metadata', // Include metadata to expose promotion_warnings for inactive manual promotions
  // 'sales_channel_id',
  'promotions.id',
  'promotions.code',
  ...
  // Line item totals (calculated from unit_price × quantity)
  'items.subtotal',
  'items.total',
  'items.tax_total',
