...
import { MedusaError, ContainerRegistrationKeys, OrderStatus } from "@medusajs/framework/utils"
import { z } from "zod"
...
export async function GET(
  ...
  const tierModuleService: TierModuleService = req.scope.resolve(TIER_MODULE)
