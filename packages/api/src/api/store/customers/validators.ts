import { z } from "zod"
import { AddressPayload, UpdateAddressPayload } from '../../utils/common-validators'
...
export const StoreCreateCustomerAddress = AddressPayload.merge(
  z.object({
    address_name: z.string().trim().min(2),
    is_default_shipping: z.boolean().optional(),
    is_default_billing: z.boolean().optional(),
  })
)

export const StoreUpdateCustomerAddress = UpdateAddressPayload.merge(
  z.object({
    address_name: z.string().trim().min(2).optional(),
    is_default_shipping: z.boolean().optional(),
    is_default_billing: z.boolean().optional(),
  })
)
