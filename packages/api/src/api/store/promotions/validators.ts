...
export const StoreGetPromotionsParams = z.object({
  ...
  cart_value: z.coerce.number().min(0, "Cart value must be a positive number").optional(),
  customer_id: z.string().optional(),
  cart_id: z.string().optional()
})

export type StoreGetPromotionsParamsType = z.infer<typeof StoreGetPromotionsParams>
