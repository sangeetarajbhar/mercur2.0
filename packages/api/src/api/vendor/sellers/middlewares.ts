...
export const vendorSellersMiddlewares: MiddlewareRoute[] = [
  {
    ...
    middlewares: [
      ...
      validateAndTransformQuery(VendorGetSellerParams, vendorSellerQueryConfig.retrieve),
    ],
  },
  {
    method: ["GET"],
    matcher: "/vendor/sellers/me",
    middlewares: [validateAndTransformQuery(VendorGetSellerParams, vendorSellerQueryConfig.list)],
  },
  {
    method: ["POST"],
    matcher: "/vendor/sellers/me",
  ...
  },
  {
    ...
    middlewares: [
      validateAndTransformQuery(VendorGetOnboardingParams, vendorOnboardingQueryConfig.retrieve),
    ],
  },
  {
    method: ["GET"],
    ...
    middlewares: [
      validateAndTransformQuery(VendorGetReviewsParams, vendorReviewQueryConfig.list),
      filterBySellerId(),
    ],
  },
  {
    ...
    middlewares: [
      validateAndTransformQuery(VendorGetReviewsParams, vendorReviewQueryConfig.retrieve),
      filterBySellerId(),
    ],
  },
  {
